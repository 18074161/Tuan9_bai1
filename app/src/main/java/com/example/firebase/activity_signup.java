    ...
    //Get Firebase auth instance
        ...
        btnResetPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(activity_signup.this, com.example.firebase.ResetPasswordActivity.class));
            }
        });
        ...
        btnSignIn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(activity_signup.this, com.example.firebase.LoginActivity.class);
